...
/** F-OPS-009 관리자 정산 목록 행입니다. */
@Getter
@Builder
public class AdminSettlementListItemResponse {
    ...
    public static AdminSettlementListItemResponse from(AdminSettlementRecord record) {
        return AdminSettlementListItemResponse.builder()
